...
HTTPDIR = HTTP
HTTPSRCS = $(addprefix $(HTTPDIR)/, HTTPRequest.cpp HTTPResponse.cpp ResponseGenerator.cpp ResponseManager.cpp RequestManager.cpp)
...
CONFIGDIR = Settings
CONFIGSRCS = $(addprefix $(CONFIGDIR)/, AliasDirective.cpp BaseSettings.cpp LocationSettings.cpp ReturnDirective.cpp ServerSettings.cpp \
					CGIDirective.cpp)
...
$(NAME1): $(SERVEROBJS1) $(HTTPOBJS) $(EVENTOBJS) $(PARSEROBJS) $(CONFIGOBJS) $(LOGGEROBJS) $(CGIOBJS)
	$(CXX) $(CXXFLAGS) -o $(NAME1) $(SERVEROBJS1) $(HTTPOBJS) $(EVENTOBJS) $(PARSEROBJS) $(CONFIGOBJS) $(LOGGEROBJS) $(CGIOBJS)
